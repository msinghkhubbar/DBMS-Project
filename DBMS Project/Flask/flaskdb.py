...
def amazon():
	...
	return render_template('amazon.html',data1 = data1, data2 = data2, data3=val)
...
def feedback():
	...
	if(request.method == 'POST'):
		...
		print(movie_name)
		print(idd)
	return render_template('feedback.html', movie_name = movie_name)
...
def login():
	...
	if form.validate_on_submit():
		if form.email.data == 'admin@blog.com' and form.password.data == 'password':
			...
			print(name)
			return redirect(url_for('home', data = name))
		else:
